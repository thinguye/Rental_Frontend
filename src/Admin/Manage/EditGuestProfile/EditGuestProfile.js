...
class EditGuestProfile extends Component {
    ...
    componentDidMount() {
        axios.get(API_BASE_URL + `/Customer/${this.state.id}`)
            .then(res => {
                ...
                this.setState({ name, id_Number, doB, phone, initial_Address, hometown, job, company, startDate, endDate, room, nationality });
            })
                        ...
                        <div style={{ padding: '2vh' }}>
                            <Form>
                                ...
                                <FormGroup>
                                    ...
                                    <Input name='room' type="text" placeholder={this.state.room} disabled />
                                </FormGroup>
                                <FormGroup>
                                ...
                                <div className='text-center'>
                                    <Button onClick={(e) => this.handleSubmit()} type="submit" color="primary"><FaSave />Lưu chỉnh sửa</Button>
                                </div>
                            </Form>
                        </div>
                    </CSSTransition>
